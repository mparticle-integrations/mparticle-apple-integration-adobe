...
//! Project version number for mParticle_Adobe_Media.
FOUNDATION_EXPORT double mParticle_Adobe_MediaVersionNumber;

//! Project version string for mParticle_Adobe_Media.
